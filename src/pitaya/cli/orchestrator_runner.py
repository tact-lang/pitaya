...
from pitaya.exceptions import DockerError, OrchestratorError, ValidationError
from pitaya.orchestration import Orchestrator
from pitaya.shared import AuthConfig, ContainerLimits, RetryConfig
...
from pitaya.config.validation import validate_full_config
...
def _validate_docker(
    ...
    try:
        from pitaya.utils.platform_utils import validate_docker_setup
