"""Workspace preparation for instance runner git operations."""
...
from .git_utils import is_valid_branch_name, relax_workspace_permissions
...
async def prepare_workspace(
    ...
    *,
    ...
    try:
        if not is_valid_branch_name(base_branch):
    ...
    try:
        ...
        if not is_valid_branch_name(base_name):
            raise GitError(f"Invalid base branch name: {base_branch}")
